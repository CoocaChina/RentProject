...
if str(os.getenv('PRODUCTION_SETTINGS')).strip() == "1": # 在开发环境中设置系统变量 PRODUCTION_SETTINGS=1
    print('是开发环境')
    print(os.getenv('PRODUCTION_SETTINGS'))
    from .dev import *
else:
    print(os.getenv('PRODUCTION_SETTINGS'))
    print('是生产环境')
...
SECRET_KEY = '8es-%o85vv4@@@(tka(tpa8_292s5wq7ips=^u5$u!j%0fjiby'
...
LOGGING = {
    ...
    'handlers': { #日志处理方式，日志实例,向哪里输出
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR,"logs/logs.log"), #注意，你的文件应该有读写权限。
            # 日志文件的最大值,这里我们设置300M
